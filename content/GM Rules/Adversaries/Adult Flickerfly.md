...
> **ATK:** +3 | **Wing Slash:** Very Close | `dice:3d20` physical
...
***Whirlwind - Action:*** Spend a Fear to whirl, making an attack against all targets within Very Close range. Targets the Flickerfly succeeds against take `dice:3d8` direct physical damage.
