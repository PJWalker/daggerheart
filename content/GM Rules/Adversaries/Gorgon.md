...
> **ATK:** +4 | **Sinew Shortbow:** Far | `dice:2d20+3` magic
...
***Crown of Serpents - Action:*** Make an attack roll against a target within Melee range using the Gorgon’s protective snakes. On a success, mark Stress to deal `dice:2d10+4` physical damage and the target must mark a Stress.
