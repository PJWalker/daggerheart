...
> **ATK:** +2 | **Branch:** Very Close | `dice:3d8+2` physical
...
***Seed Barrage - Action:*** Mark a Stress and make an attack against up to three targets within Close range, pummeling them with giant acorns. Targets the Treant succeeds against take `dice:2d10+5` physical damage.
