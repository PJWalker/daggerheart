...
> **ATK:** +3 | **Warp Blast:** Close | `dice:1d12+6` magic
...
***Remake Reality - Action:*** Spend a Fear to transform the area within Very Close range into a different biome. All targets within this area take `dice:2d6+3` direct magic damage.
