...
> **ATK:** -3 | **Rapier:** Melee | `dice:1d6+1` physical

# Features

***My Land, My Rules - Passive:*** All social actions made against the Noble on their land have disadvantage.

***Guards, Seize Them! - Action:*** Once per scene, mark a Stress to summon `dice:1d4` Bladed Guards, who appear at Far range to enforce the Noble’s will.
