...
> **ATK:** +8 | **Holy Sword:** Very Close | `dice:4d10+10` physical
...
***God Rays - Action:*** Mark a Stress to reflect a sliver of divinity as a searing beam of light that hits up to twenty targets within Very Far range. Targets must make a Presence Reaction Roll, with disadvantage if they are marked Guilty. Targets who fail take `dice:4d6+12` magic damage. Targets who succeed take half damage.
