...
| [Harrowbone Armor](Harrowbone%20Armor.md)           | 9 / 21              | 4              | ***Resilient:*** Before you mark your last Armor Slot, roll  `dice:1d6`. On a result of 6, reduce the severity by one threshold without marking an Armor Slot. |
...
| [Spiked Plate Armor](Spiked%20Plate%20Armor.md)                 | 10 / 25             | 5              | ***Sharp:*** On a successful attack against a target within Melee range, add  `dice:1d4` to the damage roll.            |
...
| [Dunamis Silkchain](Dunamis%20Silkchain.md)          | 13 / 36             | 7              | ***Timeslowing:*** Mark an Armor Slot to roll  `dice:1d4` and add its result as a bonus to your Evasion against an incoming attack. |
